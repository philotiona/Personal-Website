            ...
            <section className="w-full h-auto flex justify-center items-start box-border">
                <div className="grid grid-cols-[1fr_auto_1fr] grid-rows-[1fr_auto_1fr] aspect-square place-items-center w-fit">
                    ...
                    <div className="col-start-2 row-start-2 flex flex-row items-center justify-center w-full h-full rounded-full aspect-square relative">
                        <div className="flex flex-row items-center justify-center rounded-full aspect-square relative p-10 w-full h-full min-w-sm min-h-sm border-[0.2px] border-[var(--color-whitish)] top-0 left-0 shadow-[inset_0_30px_60px_-12px_rgba(255,255,255,0.25),_inset_0_18px_36px_-18px_rgba(255,255,255,0.3)] box-border">
                                <img 
                                    className="fixe w-8 h-8 sm:w-8 sm:h-8 lg:w-10 lg:h-10 xl:w-14 xl:h-14 flex items-center rounded-full shadow-[0_22px_70px_4px_rgba(255,255,255,0.56)]" 
                                    src="moon2.svg" 
                                    alt="Profile icon"
                                />
